                ...
                <div class="col-lg-10"
                    ...
                    <div class="row">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a class="nav-link " href="{{ url('/monthly-report') }}">Monthly</a>
                            </li>
                            <li class="nav-item "><a class="nav-link active" href="{{ url('/annual-report') }}">Annually</a>
                            </li>
                        </ul>
                        <center>
                            <div style="width: 70%">
                            ...
                            <table class="table w-50 ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong>{{ $yearlyIncome->sum('total_income') }}</strong></td>
                                    </tr>
                                </tbody>
                            </table>
                        </center>
                        <script>
                            ...
                            var yearlyIncomeData = @json($yearlyIncome);

                            // Prepare data for Chart.js
                            var data = yearlyIncomeData.map(item => item.total_income);

                            // Create an array of labels using the year
                            var labels = yearlyIncomeData.map(item => item.year);
