    ...
    <div class="container login mt-0">
        <div class="row" style="margin-bottom: 20px;">
            ...
            <div class="col-sm-8 text-center">
                ...
                <div class="row-sm" style="font-size: 40px; font-weight: bold; color:white;">PET OWNER</div>
        ...
        <div class="row" style="background-color: #dec3f0; padding:  20px 50px 20px 50px ; border-radius: 5px;">
            <div class="col-lg-2">
                ...
                <img src="{{ $owners->image ?? '' }}"
                    style="height: auto;width:100%; border: 5px solid white; border-radius: 5px;">
                </hr>
            </div>
            <div class="col-lg-10">
                <div class="row pb-1">
                    ...
                    @if ($owners->accountstatus ?? '' == 'Active')
                        ...
                        <div class="col-lg-2 text-start" style="margin-left: -45px">
                            <a href="javascript:void(0)" id="showDeactModal"
                                data-url="{{ route('findOwnerId', $owners->userID) }}"
                    ...
                    @elseif($owners->accountstatus ?? ' ' == 'Deactivated')
                        ...
                        <div class="col-lg-2 text-start" style="margin-left: -35px">
                ...
                <div class="row pb-1">
                    ...
                    <div class="col-lg-3 text-start">
                        <input type="text" id="name" name="name"
                            ...
                            value="{{ $owners->firstname ?? 'null name' }}   {{ $owners->lastname ?? 'null lastname' }}"
                            readonly>
                    </div>
                ...
                <div class="row pb-1">
                    ...
                    <div class="col-lg-3 text-start">
                        <textarea id="bio" name="bio"
                            style="background-color: #e9d6f4; width:  100%; border: 1px solid black; padding: 2px;" readonly>{{ $owners->bio ?? 'no bio' }}</textarea>
                        {{-- <input type="text" id="address" name="address"
                            style="background-color: #e9d6f4; width:  100%; border: 1px solid black; padding: 2px;"
                            value="{{ $owners->bio ?? 'no bio' }}" readonly> --}}
                    </div>
                    <div class="col-lg-1 text-start">
                    </div>
                    {{-- <div class="col-lg-2 pl-5 text-start" style="padding-left: ">
                ...
                <div class="row">
                    <div class="col-lg-2" style=" padding:  20px 0px 20px 0px ; border-radius: 5px;">
                        ...
                        <div style="margin-bottom: 5px;">
                            ...
                            <a href="{{ route('showCatOwners', $owners->userID) }}">
                        ...
                        <div style="margin-bottom: 5px;">
                            ...
                            <a href="{{ route('showDogOwners', $owners->userID) }}">
                        ...
                        <div style="margin-bottom: 5px;">
                            <a href="{{ route('showRabbitOwners', $owners->userID) }}">
                        ...
                        <div style="margin-bottom: 5px;">
                            <a href="{{ route('showHamsterOwners', $owners->userID) }}">
                        ...
                        <div style="margin-bottom: 5px;">
                            <a href="{{ route('showBirdOwners', $owners->userID) }}">
                    ...
                    <div class="col-lg-10"
                        ...
                        <div class="row">
                            <div id="list">
                                @include('manageAcc.petowner.search.petsresults')
